...
export const constantRoutes = [
  ...
  },
  {
    path: '/test',
    component: Layout,
    meta: { title: '测试界面', icon: 'link' },
    children: [
      {
        path: 'index',
        name: 'TestIndex',
        component: () => import('@/views/testPage/index'),
        meta: { title: '测试一', icon: 'form' }
      },
      {
        path: 'pagetwo',
        name: 'PageTwo',
  ...
  },
  {
    path: '/level',
    component: Layout,
    meta: { title: '等级管理', icon: 'link' },
    children: [
      {
        path: 'list',
        name: 'LevelList',
        component: () => import('@/views/level/list'),
        meta: { title: '等级菜单', icon: 'form' }
      },
      {
        path: 'add',
        name: 'LevelAdd',
  ...
  },
  {
    path: '/message',
    component: Layout,
    meta: { title: '信息管理', icon: 'link' },
    children: [
      {
        path: 'list',
        name: 'MessageList',
        component: () => import('@/views/message/list'),
        meta: { title: '信息菜单', icon: 'form' }
      },
      {
        path: 'add',
        name: 'MessageAdd',
